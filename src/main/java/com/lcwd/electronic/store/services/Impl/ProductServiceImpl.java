...
public class ProductServiceImpl implements ProductServiceI {
    ...
    public ProductDto createProduct(ProductDto productDto) {
        log.info("Sending dao call to create product");
        ...
        log.info("Completed dao call to successful create product");
        return productDto1;
    }
    ...
    public ProductDto updateProduct(ProductDto productDto, String productId) {
        ...
        log.info("Sending dao call to update product");
        ...
        log.info("Completed dao call to successful update product");
        return updatedProductDto;
    }

    @Override
    public void deleteProduct(String productId) {
        log.info("Sending dao call to delete product");
        ...
        log.info("Completed dao call to successful delete product");
    }
    ...
    public ProductDto getSingleProduct(String productId) {
        log.info("Sending dao call to get single product");
        ...
        log.info("Completed dao call to successful get single product");
        return singleProductDto;
    }

    @Override
    public ProductDto searchProduct(String keyword) {
        log.info("Sending dao call to get product keyword");
        ...
        log.info("Completed dao call to successful get product keyword");
        return ProductDtoByTitleContaining;
    }

    @Override
    public ProductDto createProductWithCategory(ProductDto productDto, String categoryId) {
        log.info("Sending dao call to get product with category");
